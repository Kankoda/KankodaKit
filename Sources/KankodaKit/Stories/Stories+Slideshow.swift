...
public extension Stories {
    ...
    /**
     This slideshow automatically navigates through a set of
     customizable slide views.
     */
    struct Slideshow<Slide, BackgroundView: View, ButtonView: View, SlideView: View>: View {
        ...
        public init(
            slides: [Slide],
            config: SlideshowConfiguration = .standard,
        ...
        private let config: SlideshowConfiguration
...
public extension Stories.Slideshow {
    
    /// A function used to generate a slide background view.
    typealias BackgroundBuilder = (Slide) -> BackgroundView
    
    /// A function used to generate a slide primary button.
    typealias ButtonBuilder = (Slide) -> ButtonView
    
    /// A function used to generate a slide view.
    typealias SlideViewBuilder = (Slide) -> SlideView
}


// MARK: - View Builders

private extension Stories.Slideshow {
