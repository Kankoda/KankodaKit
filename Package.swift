...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/danielsaidi/OnboardingKit.git", .upToNextMajor(from: "9.2.1")),
        .package(url: "https://github.com/danielsaidi/PresentationKit.git", .upToNextMajor(from: "1.3.0")),
        .package(url: "https://github.com/danielsaidi/ScanCodes.git", .upToNextMajor(from: "0.2.0")),
        .package(url: "https://github.com/danielsaidi/StandardActions.git", .upToNextMinor(from: "1.0.1")),
